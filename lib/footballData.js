...
// Championnats proposés (codes canoniques, communs à toute l'app)
...
export async function findMatch(matchId) {
  // football-data.org n'a pas d'accès direct par ID : on lui passe la liste
  // des compétitions pour qu'il les parcoure. Les autres ignorent l'argument.
  return provider().findMatch(matchId, COMPETITIONS);
}
