...
import { findMatch, getStandings } from "@/lib/footballData";
...
export async function POST(request) {
  ...
  try {
    ...
    const { analysis, source } = await analyzeMatch(match, prediction, standings);

    return NextResponse.json({ match, prediction, analysis, source });
  } catch (e) {
